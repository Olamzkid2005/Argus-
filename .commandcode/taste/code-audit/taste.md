...
- When verifying claims in a document/checklist against source code, spot-check BOTH directions — items marked as fixed AND items marked as unfixed — to catch stale claims where the code has changed but the document hasn't been updated. Confidence: 0.70
