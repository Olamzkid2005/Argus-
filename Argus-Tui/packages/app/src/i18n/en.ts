export const dict = {
  ...
  "command.attackMap.toggle": "Toggle attack map",
  ...
  "status.popover.tab.attack": "Attack Map",
  "status.popover.attack.chains": "Chains",
  "status.popover.attack.paths": "Paths",
  "status.popover.attack.risk": "Risk",
  "status.popover.attack.press": "Press",
  "status.popover.attack.empty": "No attack chains detected yet.",
