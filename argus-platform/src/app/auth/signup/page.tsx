            ...
            {password && (
              <div className="space-y-1.5">
                <div className="flex gap-1">
                  <div
                    className={`h-1 flex-1 rounded-full transition-colors ${password.length >= 8 ? "bg-cyan-500" : "bg-slate-700"}`}
                  />
                  <div
                    className={`h-1 flex-1 rounded-full transition-colors ${/[A-Z]/.test(password) ? "bg-cyan-500" : "bg-slate-700"}`}
                  />
                  <div
                    className={`h-1 flex-1 rounded-full transition-colors ${/[a-z]/.test(password) ? "bg-cyan-500" : "bg-slate-700"}`}
                  />
                  <div
                    className={`h-1 flex-1 rounded-full transition-colors ${/[0-9]/.test(password) ? "bg-cyan-500" : "bg-slate-700"}`}
                  />
                </div>
