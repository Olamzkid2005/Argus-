...
export function useEngagementEvents(
  ...
  // Ref for stopPolling to avoid temporal dead zone issues (stopPolling is defined later)
  ...
  // Use ref for engagementId to avoid stale closure in event handlers (fix 1.6)
