...
- Name: frontend-features.spec.ts >> 1. Homepage loads correctly
- Location: tests/frontend-features.spec.ts:7:5
...
Locator: locator('a[href="/auth/signin"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href="/auth/signin"]')
