 ...
 */
import { generateIdempotencyKey, isJobProcessed, markJobProcessing, markJobComplete } from '@/lib/redis';
...
describe('Redis Job Queue', () => {
  describe('generateIdempotencyKey', () => {
    it('should generate consistent SHA-256 hash', () => {
      const key1 = generateIdempotencyKey('eng-123', 'recon', 'https://example.com');
      const key2 = generateIdempotencyKey('eng-123', 'recon', 'https://example.com');
    ...
    it('should generate different hashes for different inputs', () => {
      const key1 = generateIdempotencyKey('eng-123', 'recon', 'https://example.com');
      const key2 = generateIdempotencyKey('eng-456', 'recon', 'https://example.com');
