...
def _differential_analysis(target_url, session, findings):
    ...
    test_cases = [
        ...
        },
        {
            ...
            "method": "GET",
            "url": f"{target_url}?id=1&id=2&id=3",
            "headers": {},
        },
        {
            "name": "null_byte_injection",
            "method": "GET",
            "url": f"{target_url}?file=test.txt%00.jpg",
            "headers": {},
        },
        {
    ...
    for test in test_cases:
        try:
            ...
            logger.debug("Differential test failed: %s", test["name"])
