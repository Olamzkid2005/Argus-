...
class TestAgentConstants:
    def test_constants_defaults_exist(self):
        ...
        assert isinstance(CONFIG.llm_agent.enabled, bool)
        ...
        assert isinstance(CONFIG.llm_agent.max_tokens_plan, int)
        ...
        assert isinstance(CONFIG.retries.llm_agent_max_retries, int)
