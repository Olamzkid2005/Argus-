...
sys.modules['tracing'] = MagicMock()
sys.modules['websocket_events'] = MagicMock()
sys.modules['tools.tool_runner'] = MagicMock()
sys.modules['tools.web_scanner'] = MagicMock()
sys.modules['parsers.parser'] = MagicMock()
sys.modules['parsers.normalizer'] = MagicMock()
sys.modules['database.repositories.finding_repository'] = MagicMock()
sys.modules['database.repositories.engagement_repository'] = MagicMock()
