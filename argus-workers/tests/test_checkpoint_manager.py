...
class TestCheckpointManager:
    ...
    def test_save_checkpoint(self, manager, mock_db_conn):
        ...
        # release_connection is called twice: once by _ensure_db() connectivity
        # check, once by save_checkpoint()'s finally block.
        assert mock_db.release_connection.call_count == 2
        mock_db.release_connection.assert_any_call(mock_conn)
