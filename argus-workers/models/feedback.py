...
class FeedbackLearningLoop:
    ...
    def on_feedback(self, feedback: FindingFeedback) -> dict | None:
        ...
        All DB operations use a single shared connection within one transaction
        to prevent partial updates (H2-11).
        ...
        try:
            ...
            self._store_feedback(cursor, feedback)
    ...
    def _store_feedback(self, cursor, feedback: FindingFeedback) -> None:
    ...
    def _update_finding(self, cursor, feedback: FindingFeedback) -> None:
